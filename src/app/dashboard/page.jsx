...
const Dashboard = () => {
  ...
  return (
    <div className='pt-28 lg:px-[10rem] min-h-screen md:px-[3rem] px-[3rem]'>
        <div className="flex flex-col gap-3">
         ...
         <h1 className="text-2xl mt-10"> Learning resources</h1>
          ...
          {
            courses ? (
              <h1 className="text-2xl text-center mt-24 flex items-center gap-3 justify-center">No course available yet, but hey it's on the way<span><PiGithubLogoDuotone /></span></h1>
            ) :(
